...
<div class="container-fluid">
    <div class="row">
        <form id="formTambahBarang" action="{{url('goodCategoryStore')}}" method="post" name="formTambahBarang">
            {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <div class="d-grid gap-1">
                        <div class="row form-group">
                            ...
                            <div class="col-md-5">
                                <input id="idMaterial" name="idMaterial" type="text" class="form-control text-md-left" value="Bahan Pendukung Produksi" placeholder="Bahan Pendukung Produksi" disabled>
                            </div>
                            ...
                            <div class="col-md-5">
                                <input id="name" name="name" type="text" class="form-control text-md-left" value="{{old('name')}}" placeholder="Nama harus unik untuk bahan tersebut">
                            </div>
                        </div>

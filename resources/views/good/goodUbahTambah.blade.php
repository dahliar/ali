...
<div class="container-fluid">
    <div class="row">
        <form id="formTambahBarang" action="{{url('goodUbahTambah')}}" method="post" name="formTambahBarang">
            {{ csrf_field() }}
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-grid gap-1">
                        ...
                        <div class="row form-group">
                            <div class="col-md-3 text-md-end">
                                <span class="label">Jumlah Penambahan*</span>
                            </div>
                            <div class="col-md-3">
                                <div class="input-group">
                                    <input id="amountTambah" name="amountTambah" type="text" class="form-control text-end" value="{{old('amountTambah',0)}}" placeholder="gunakan titik untuk pecahan">
                        ...
                        <div class="row form-group">
                            <div class="col-md-3 text-md-end">
                                <span class="label">Harga beli total*</span>
                            </div>
                            <div class="col-md-3">
                                <div class="input-group">
                                    <span name="spanMinimal" id="spanMinimal" class="input-group-text col-md-1">Rp. </span>
                                    <input id="hargaTotal" name="hargaTotal" type="text" class="form-control text-end" value="{{old('hargaTotal', $good->hargaTotal)}}" placeholder="gunakan titik untuk pecahan">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-3">
                                <input id="purchaseDate" name="purchaseDate" type="date" class="form-control text-end" value="{{old('purchaseDate')}}">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-3 text-md-end">
                                <span class="label">No invoice pembelian</span>
                            </div>
                            <div class="col-md-3">
                                <input id="invoiceNumber" name="invoiceNumber" type="text" class="form-control text-end" value="{{old('invoiceNumber')}}">
                            </div>
                        </div>
                        <div class="row form-group">

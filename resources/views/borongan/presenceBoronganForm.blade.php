...
<script type="text/javascript"> 
    ...
    function selectOptionChange($jenisId){
        $.ajax({
            url: '{{ url("getStandarBoronganPrice") }}/'+$jenisId,
            type: "GET",
            ...
            success:function(data){
                if(data){
                    ...
                    for(i=0; i<data.length; i++){
                        ...
                        (i+1)+". "+data[i].nama+" - Rp."+data[i].harga+"/Kg"
                        '</option>';
                        $('#standarBorongan').html(html);
                    }
                }
            }
        });
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group mb-2">
                            <div class="col-md-3 text-end">
                                <span class="label" id="spanPayment">Tipe</span>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row form-group mb-2">
                            <div class="col-md-3 text-end">
                                <span class="label" id="spanPayment">Jenis Borongan</span>
                            </div>
                            <div class="col-md-4">
                                <select id="standarBorongan" name="standarBorongan" class="form-select">
                                    <option value="-1" selected>--Pilih salah satu--</option>
                                </select>
                            </div>                    
                        </div>
                        ...
                        <div class="row form-group mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input type="number" id="hargaSatuan" name="hargaSatuan" class="form-control text-end" value="{{old('hargaSatuan')}}" readonly>
                        ...
                        <div class="row form-group mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    <input type="number" id="bagiHasil" name="bagiHasil" class="form-control text-end" value="{{old('bagiHasil',0)}}" step="1" min="0" max="20">

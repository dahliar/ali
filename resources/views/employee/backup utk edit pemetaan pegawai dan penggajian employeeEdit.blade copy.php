                ...
                <form id="EmployeeEditForm" action="{{route('employeeUpdate')}}" method="POST" name="EmployeeEditForm" autocomplete="off">
                    ...
                    <div class="d-grid gap-1">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-8">
                                <input id="email" name="email" type="email" class="form-control" autocomplete="off" value="{{$choosenUser->email}}">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-2 text-end">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                <input id="nik" name="nik" type="text" class="form-control" required autocomplete="none" value="{{$employee->nik}}">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-2 text-end">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" id="address" name="address" rows="4" cols="50" required autocomplete="none">{{$employee->address}}</textarea>
                            </div>
                        </div>

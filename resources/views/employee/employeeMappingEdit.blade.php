...
<script type="text/javascript"> 
    function myFunction(){
        Swal.fire({
            title: 'Ubah pemetaan karyawan?',
            text: "Ubah pemetaan data karyawan.",
            icon: 'info',
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    title: 'Data pemetaan karyawan diubah',
                    text: "Simpan data pemetaan karyawan.",
                    icon: 'info',
                    confirmButtonColor: '#3085d6',
                ...
                Swal.fire(
                    'Batal disimpan!',
                    "Peubahan data pemetaan karyawan dibatalkan",
                    'info'
                    );
            }
        })

...
<script type="text/javascript">
    ...
    function barcodeItemList(transactionId, loadingDate){
        window.open(('{{ url("scanRekapKeluarHari") }}'+"/"+transactionId+"/"+loadingDate), '_self');
    }
            ...
            <div class="modal-header">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb primary-color my-auto">
                        ...
                        <li class="breadcrumb-item active">Rekapitulasi Scan Keluar</li>
                    </ol>
                </nav>
            </div>
        </div>

                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="date" id="transactionDate" name="transactionDate" class="form-control text-md-end" value="{{ date('Y-m-d', strtotime($transaction->transactionDate)) }}" >
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input type="date" id="loadingDate" name="loadingDate" class="form-control text-md-end" value="{{ date('Y-m-d', strtotime($transaction->loadingDate)) }}" >
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input id="payment" name="payment" type="number" step="0.01" value="{{ $transaction->payment }}" class="form-control text-md-end" placeholder="use commas">
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input id="advance" name="advance" type="number" step="0.01" value="{{ $transaction->advance }}" class="form-control text-md-end" placeholder="use commas">
                            </div>
                        </div>
                    </div>
                    <div class="row form-group">

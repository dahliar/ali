...
<script type="text/javascript"> 
    ...
    $(document).ready(function() {
        ...
        $('#transactionNum').change(function(){

            var transactionNum = $(this).val()+document.getElementById("transactionNumFormat").value;

            $.ajax({
                url: '{{ url("checkTransactionNum") }}',
                type: "get",
                data: {
                ...
                success:function(data){
                    if (data>0){
                        document.getElementById("transactionNumInfo").textContent="Nomor telah digunakan";
                        Swal.fire(
            ...
            <form id="transactionForm" action="{{url('transactionUpdate')}}"  method="POST" name="transactionForm" enctype="multipart/form-data">
                ...
                <div class="d-grid gap-2">
                    ...
                    <div class="row form-inline">
                        ...
                        <div class="col-4">
                            @if ($transactionNum > 1)
                            <input id="transactionNum" name="transactionNum"  class="form-control text-md-end"  value="{{ $transaction->transactionNum}}">
                            @else
                            <input id="transactionNum" name="transactionNum"  class="form-control text-md-end" value="{{$transactionNumFormatted}}">
                            @endif
                            <span style="font-size:9px" class="label" id="transactionNumInfo">Format : Nomor/INV-ALS/Bulan/Tahun</span>
                        </div>
                        @if ($transactionNum <= 1)
                ...
                <div class="row form-group">
                    ...
                    <div class="col-4">
                        <input id="pinum" name="pinum"  class="form-control text-md-end"  value="{{ $transaction->pinum}}" readonly>
                        <input id="transactionId" name="transactionId"  class="form-control"  value="{{$transaction->id}}" type="hidden" readonly>
                    </div>
                </div>      
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input id="pebNum" name="pebNum" class="form-control text-md-end"

...
<script type="text/javascript">
    ...
    function tambahItem(id){
        window.open(('{{ url("detailundernameList") }}'+"/"+id), '_blank');
    }
    function editTransaksi(id){
        window.open(('{{ url("undernameEdit") }}'+"/"+id), '_self');
    }
    ...
    function myFunction(){
        ...
        $('#datatable').DataTable({
            ...
            ajax:{
                url: '{{ url("getAllUndernameTransaction") }}',
                data: function (d){
                    d.negara = negara,
    ...
    <div class="container-fluid">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button onclick="tambahTransaksiUndername()" class="btn btn-primary" data-toggle="tooltip" data-placement="top" data-container="body" title="Tambah Transaksi">

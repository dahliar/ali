...
<body>
    <div class="container-fluid">
        ...
        <div class="card card-body">
            <form action="{{route('undernameUpdate')}}" method="POST">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                        <input id="pinum" name="pinum"  class="form-control" value="{{ old('pinum', $undername->pinum) }}" placeholder="PI Number">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-3 text-md-right">
                    ...
                    <div class="col-md-8">
                        <input id="transactionNum" name="transactionNum"  class="form-control" value="{{ old('transactionNum', $undername->transactionNum) }}" placeholder="Transaction Number">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-md-3 text-md-right">

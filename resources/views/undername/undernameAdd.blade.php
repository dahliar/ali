                ...
                if (company > 0) {
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data) {
                                $('[name="companydetail"]').val(data.address + '. ' + data
                                    .nation);
                            } else {}
                        }
                    });
                    ...
                    <div class="col-md-10">
                        <form action="{{ url('undernameStore') }}" method="POST">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="shipper" name="shipper" class="form-control"
                                        value="{{ old('shipper', 'PT. ANUGRAH LAUT INDONESIA.') }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                                ...
                                <div class="col-md-8">
                                    <input id="pinum" name="pinum" class="form-control" value="{{ old('pinum') }}"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="transactionNum" name="transactionNum" class="form-control"
                                        value="{{ old('transactionNum') }}" placeholder="Transaction Number">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea id="companydetail" name="companydetail" rows="4" class="form-control" style="min-width: 100%"
                                        placeholder="Information about the company such as address, tax id, contact number etc">{{ old('companydetail') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="packer" value="{{ old('packer') }}" name="packer" type="text"
                                        class="form-control" placeholder="Packer name">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                                ...
                                <div class="col-md-8">
                                    <input id="loadingPort"
                                        value="{{ old('loadingPort', 'Surabaya Port, East Java Indonesia') }}"
                                        name="loadingPort" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                                ...
                                <div class="col-md-8">
                                    <input id="destinationPort" name="destinationPort"
                                        value="{{ old('destinationPort') }}" type="text" class="form-control"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <select id="orderType" name="orderType" class="form-select">
                                        ...
                                        <option value="1" @if (old('orderType') == 1) selected @endif>FOB
                                        </option>
                                        <option value="2" @if (old('orderType') == 2) selected @endif>CNF
                                        </option>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="containerParty" name="containerParty" type="text"
                                        value="{{ old('containerParty') }}" class="form-control"
                                        placeholder="vessel size such as 1 x 40 or 1 x 20">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                                    ...
                                    <select id="forwarder" name="forwarder" class="form-select">
                                        ...
                                        @foreach ($forwarders as $forwarder)
                                            @if ($forwarder->id == old('forwarder'))
                                                <option value="{{ $forwarder->id }}" selected>{{ $forwarder->name }}
                                                </option>
                                            @else
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="date" id="loadingDate" name="loadingDate"
                                            value="{{ old('loadingDate', date('Y-m-d')) }}"
                                            class="form-control text-end">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="date" id="departureDate" name="departureDate"
                                            value="{{ old('departureDate', date('Y-m-d')) }}"
                                            class="form-control text-end">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="date" id="arrivalDate" name="arrivalDate"
                                            class="form-control text-end"
                                            value="{{ old('arrivalDate', date('Y-m-d')) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="containerNumber" value="{{ old('containerNumber') }}"
                                        name="containerNumber" type="text" class="form-control"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="containerSeal" value="{{ old('containerSeal') }}" name="containerSeal"
                                        type="text" class="form-control" placeholder="Seal number">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                                ...
                                <div class="col-md-8">
                                    <input id="containerVessel" value="{{ old('containerVessel') }}"
                                        name="containerVessel" type="text" class="form-control"
                                        placeholder="Vessel name & number">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                                ...
                                <div class="col-md-8">
                                    <select id="containerType" name="containerType" class="form-select">
                                        <option value="-1" selected>--Choose One--</option>
                                        <option value="1" @if (old('containerType') == 1) selected @endif>Dry
                                        </option>
                                        <option value="2" @if (old('containerType') == 2) selected @endif>Reefer
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="bl" value="{{ old('bl') }}" name="bl" type="text"
                                        class="form-control" placeholder="Bill of Lading number">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <select id="paymentTo" name="paymentTo" class="form-select">
                                        <option value="-1" selected>--Choose One--</option>
                                        <option value="1" @if (old('paymentTo') == 1) selected @endif>Internal
                                        </option>
                                        <option value="2" @if (old('paymentTo') == 2) selected @endif>Supplier
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea id="paymentBankAddress" name="paymentBankAddress" rows="4" class="form-control"
                                        style="min-width: 100%" placeholder="Bank Address">{{ old('paymentBankAddress') }}</textarea>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="paymentAccountName" name="paymentAccountName" class="form-control"
                                        value="{{ old('paymentAccountName') }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-3 text-md-right">
                                ...
                                <div class="col-md-8">
                                    <input id="swiftcode" name="swiftcode" class="form-control"
                                        value="{{ old('swiftcode') }}">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input id="paymentAmount" name="paymentAmount" type="number" step="0.01"
                                            value="{{ old('paymentAmount') }}" class="form-control text-end"
                                            placeholder="use commas for decimals">
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input id="advanceAmount" name="advanceAmount" type="number" step="0.01"
                                            value="{{ old('advanceAmount') }}" class="form-control text-end"
                                            placeholder="use commas for decimals">
                                    </div>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-md-8">
                                    <select id="paymentStatus" name="paymentStatus" class="form-select">
                                        <option value="-1" selected>--Choose One--</option>
                                        <option value="1" @if (old('paymentStatus') == 1) selected @endif>Saldo
                                            belum diterima dari buyer</option>
                                        <option value="2" @if (old('paymentStatus') == 2) selected @endif>Saldo di
                                            internal</option>
                                        <option value="3" @if (old('paymentStatus') == 2) selected @endif>Saldo
                                            partial transfer ke supplier</option>
                                        <option value="4" @if (old('paymentStatus') == 3) selected @endif>Saldo
                                            full transfer ke supplier</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row form-group">
